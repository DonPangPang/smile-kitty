...
public class CatRepatriationApply : AggregateRoot, IEntity, ICreationTime, IModificationTime, ISafeDelete
{
    ...
    public void HandleFlow(FlowResult result, User handleUser)
    {
        ...
        {
            AddLocalEvent(new CatRepatriationApplyAddRepatriationRecordEvent()
            {
                CatId = CatId,
                UserId = UserId,
